...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->selected((*reinterpret_cast< QRect(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (MyWidget::*_t)(QRect );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::selected)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void MyWidget::selected(QRect _t1)
{
