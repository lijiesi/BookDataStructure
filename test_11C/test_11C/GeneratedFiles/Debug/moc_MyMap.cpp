...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MyMap_t, stringdata) + ofs \
...
const QMetaObject MyMap::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_MyMap.data,
      qt_meta_data_MyMap,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyMap.stringdata))
