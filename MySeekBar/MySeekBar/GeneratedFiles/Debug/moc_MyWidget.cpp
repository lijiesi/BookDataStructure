...
QT_MOC_LITERAL(7, 48, 3)
    ...
    "MyWidget\0clicked\0\0progress\0tracking\0"
    "pos\0focused\0yes"
};
...
void MyWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->tracking((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QPoint(*)>(_a[2]))); break;
        case 2: _t->focused((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::clicked)) {
                *result = 0;
            }
        }
        {
            typedef void (MyWidget::*_t)(int , QPoint );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::tracking)) {
                *result = 1;
            }
        }
        {
            typedef void (MyWidget::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyWidget::focused)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 1
void MyWidget::tracking(int _t1, QPoint _t2)
{
...
// SIGNAL 2
void MyWidget::focused(bool _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
